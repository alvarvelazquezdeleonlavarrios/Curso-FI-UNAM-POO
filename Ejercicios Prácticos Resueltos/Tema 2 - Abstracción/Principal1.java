...
class Principal1 {
	...
	public static void main(String[] args) {
		...
		*/
		...
		jugador_2.nombre = "Luigi";
		jugador_2.vidas = 5;
		jugador_2.velocidad_mov = 2.7f;

		System.out.println("\n--------- Propiedades Jugador 2 --------------");
		System.out.println("Nombre del jugador 2: " + jugador_2.nombre);
		System.out.println("Vidas del jugador 2: " + jugador_2.vidas);
		System.out.println("Velocidad de movimiento del jugador 2: " + jugador_2.velocidad_mov);
		System.out.println("¿En el suelo jugador 2?: " + jugador_2.en_suelo);
		System.out.println("");
