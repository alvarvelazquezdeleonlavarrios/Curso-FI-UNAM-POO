// Definición de una nueva clase llamada "Principal.java"
class Principal {
	
	// Función principal del programa a ejecutar
	public static void main(String[] args){
		/* -------- Ejercicio #1 -----------
			Supongamos que nos enontramos trabajando en un supermercado/tienda de abarrotes.

			Nuestro superior o jefe nos dice que programó dos nuevas clases para dos nuevos
			productos que se agregarán a la "base de datos" de la tienda. Dichas clases son:
		...
		*/
		...
		/* -------- Ejercicio #3 -----------
			Ahora se nos solicita que realicemos una segunda prueba:

			1.- Utilizando la misma referencia de tipo PapasFritas que creaste en la actividad
		...
		*/
		...
		/* -------- Ejercicio #4 -----------
			Ahora se nos solicita que realicemos una tercera prueba:
