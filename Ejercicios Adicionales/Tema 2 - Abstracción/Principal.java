// Identificador de clase --> Principal
class Principal {
	...
	public static void main(String[] args) {
		...
		/* ---------- Ejercicio #1 -----------
			Supongamos que ahora estamos trabajando en una agencia de automóviles.

			Se nos comenta que dentro del sistema informático de la agencia se encuentra un archivo
			en lenguaje Java que es el que funcionará como clase para objetos de tipo Coche.
			Sin embargo, dicha clase está vacía (únicamente se declaró una "plantilla vacía").
			...
			- Si tiene sistema de aire acondicionado o no


			Por lo tanto, con toda la información proporcionada en esta actividad,
			debes realizar lo siguiente:

			1.- Crea los atributos correspondientes para la clase Coche.java. 
			Realiza las modificaciones necesarias y compila dicha clase para verificar 
			que no haya errores.
		*/
		...
		/* ---------- Ejercicio #2 -----------
			Una vez que hayas conseguido implementar los atributos de un objeto de tipo Coche,
			ahora se nos pide analizar que estos vehículos pueden realizar ciertas acciones,
			como lo son:
			- Encender
			- Apagar
			- Acelerar
		...
		*/
		...
		/* ---------- Ejercicio #4 -----------
			...
			1.- Crea un nuevo objeto de tipo Coche e inicializa sus atributos con los datos que se
			muestran en esta actividad. Ya sea que utilices alguno de los constructores que programaste,
			o llames directamente a los atributos por referencia, ¡¡o ambos!!
